...
public class CourseResource {
    ...
    @RequestMapping(value = "/suggestKie",
            method = RequestMethod.POST,
            produces = "application/json")
    public List<Course> getSubjectsByKieServer(@RequestBody SubjectList subjects){
        List<Course> sub = courseService.getSuggestedCourseByKieServer(subjects.getItems());
        return sub;
    }
}
